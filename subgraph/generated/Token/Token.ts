...
export class BlackList extends ethereum.Event {
  get params(): BlackList__Params {
    return new BlackList__Params(this);
  }
}

export class BlackList__Params {
  _event: BlackList;

  constructor(event: BlackList) {
    this._event = event;
  }
